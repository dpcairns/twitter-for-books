import { makeArray, tweetIsValid } from './tweet-utils.js';

const longerString = `To be, or not to be, that is the question:
...
test('should reject tweets that cut off words', () => {
  ...
  const invalid = tweetIsValid('to be or not to be that is the qu', longerString);
